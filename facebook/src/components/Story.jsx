...
<div data-hs-carousel='{
  ...
  <div class="hs-carousel scrollbar scrollbar-hide scroll-smooth overflow-x-auto rounded-lg">
    <div class="relative h-52 -mx-1">
      <div class="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap opacity-0 cursor-grab transition-transform duration-700 hs-carousel-dragging:transition-none hs-carousel-dragging:cursor-grabbing">
        <div class="hs-carousel-slide px-1 relative"> 
          <button type="button" class="absolute flex shrink-0 justify-center items-center mt-2 ml-2 gap-2 size-[36px] text-sm font-medium rounded-full border-3 border-blue-500 bg-white text-blue-600 focus:outline-none disabled:opacity-50 disabled:pointer-events-none z-20">
  ...
  <button type="button" class="hs-carousel-prev hs-carousel-disabled:opacity-50 hs-carousel-disabled:pointer-events-none absolute inset-y-0 start-0 inline-flex justify-center items-center my-auto ml-1 size-10 rounded-full text-gray-800 hover:bg-white focus:outline-none focus:bg-gray-800/10">
  ...
  <button type="button" class="hs-carousel-next hs-carousel-disabled:opacity-50 hs-carousel-disabled:pointer-events-none absolute inset-y-0 end-0 inline-flex justify-center items-center my-auto mr-1 size-10 text-gray-800 hover:bg-white focus:outline-none focus:bg-gray-800/10 rounded-full">
